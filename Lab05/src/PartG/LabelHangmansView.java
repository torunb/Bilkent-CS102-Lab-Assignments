...
public class LabelHangmansView extends JPanel implements IHangmanView
{
    ...
    {
		numOfIncorrectTries.setText("Incorrect tries: " + hangman.getNumOfIncorrectTries());
        knownSoFar.setText("Known so far: "+ hangman.getKnownSoFar());
        usedLetters.setText("Letters that you used so far: " + hangman.getUsedLetters());
        lost.setText("Have you lost the game: " + hangman.hasLost());
	}
